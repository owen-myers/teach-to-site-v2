...
const MAPLinkStyle = "font-libre text-sm text-blue-600 underline hover:text-blue-800 transition duration-200 ease-in-out";
        ...
        <div>
            ...
            <div className="max-w-3xl mx-auto px-4">
                <div>
                    ...
                    <h2 className="font-manrope text-md mb-8">GPT-assisted aggregation of accessible transit resources</h2>
                </div>
                <div className="mb-12">
                    ...
                    <p className="font-libre text-sm">10 weeks</p>
                    </div>
                    <div className ="flex justify-left items-center mb-4">
                        <div className="mr-4 flex-shrink-0">
                        <Image src={ Package } alt="A wrapped package." width={16} height={16}/>
                        </div>
                    <p className="font-libre text-sm">Prototype</p>
                    </div>
                </div>
                <div>
                    <Section
